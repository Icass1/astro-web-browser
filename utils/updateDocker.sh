...
docker run --name WebBrowser --user $(id -u icass):$(id -g icass) -d -t --restart unless-stopped -p 8081:4321 -v /home/icass/HomeDrive/root:/mnt/main -v /home/icass/HomeDrive/files2database:/usr/src/app/database astro-web-browser
